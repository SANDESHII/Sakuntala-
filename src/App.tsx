            ...
            <main className="max-w-7xl mx-auto px-6 pt-32 pb-24 space-y-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
                    ...
                    <nav className="flex items-center p-1 bg-neutral-900 border border-neutral-800 rounded-xl">
                        {[
                            ...
                            <button
                                key={tab.id}
                                onClick={() => setActiveTab(tab.id as 'terminal' | 'backtest')}
                                className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-xs font-bold transition-all ${activeTab === tab.id
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'terminal' ? (
                        ...
                        >
                            {backtestSummary ? (
                                <BacktestDisplay summary={backtestSummary} />
                            ) : (
                                <div className="p-24 text-center">
                                    <p className="text-[10px] font-black text-neutral-600 uppercase tracking-widest animate-pulse">Initializing historical audit...</p>
                                </div>
                            )}
                        </motion.div>
                    )}
