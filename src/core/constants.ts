...
export const FOOTBALL_DATA_CONFIG = { BASE_URL: 'https://www.football-data.co.uk/mmz4281', LEAGUE_MAP: { 'EPL': 'E0', 'CHAMPIONSHIP': 'E1', 'LA_LIGA': 'SP1', 'SERIE_A': 'I1', 'BUNDESLIGA': 'D1' } as Record<string, string> };
