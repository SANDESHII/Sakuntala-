...
export class FreeDataService {
    static async getTeamStats(teamName: string, league: string) {
    ...
    static async getLiveOdds(league: string) {
        if (!ODDS_API_KEY) return [];
        const sportKey = this.getOddsSportKey(league);
        try {
