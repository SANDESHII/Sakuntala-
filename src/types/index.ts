...
export interface MatchContext { weatherData?:{ temperature:number; condition:string; }; referee?:RefereeProfile; homeStyle?:TeamStyleProfile; awayStyle?:TeamStyleProfile; league?:string; homeSeasonXG?:number; awaySeasonXG?:number; homeSeasonXGA?:number; awaySeasonXGA?:number; date?:string; marketOdds?:{ pinnacleOver15?:number; pinnacleUnder35?:number; }; groundingLog?:{ citations:Citation[]; varianceAlerts:string[]; }; audit?:{ signalIntegrity:string; alphaAdjustment:string; redCardRegime:string; dataReliability:string; sampleSize:number; }; }
